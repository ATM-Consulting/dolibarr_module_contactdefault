...
class modContactDefault extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->module_parts = array(
            ...
            //'css' => '/contactdefault/css/mycss.css.php',
        ...
        $this->langfiles = array("contactdefault@contactdefault"); // langfiles@contactdefault
        // Constants
        ...
        /* Example:
          ...
          if (! isset($conf->contactdefault->enabled)) $conf->contactdefault->enabled=0;
          $this->dictionnaries=array(
          'langs'=>'contactdefault@contactdefault',
        ...
        //	// Use '$conf->contactdefault->enabled' if entry must be visible if module is enabled.
        //	'enabled'=>'$conf->contactdefault->enabled',
        //	// Use 'perms'=>'$user->rights->contactdefault->level1->level2'
        ...
        //	'mainmenu'=>'contactdefault',
        //	'leftmenu'=>'contactdefault',
        //	'url'=>'/contactdefault/pagelevel1.php',
        //	// Lang file to use (without .lang) by module.
        //	// File must be in langs/code_CODE/ directory.
        //	'langs'=>'mylangfile',
        //	'position'=>100,
    ...
    public function init($options = '')
    {
        ...
        $url = dol_buildpath('/contactdefault/script/create-maj-base.php', 2);
    ...
    {
        return $this->_load_tables('/contactdefault/sql/');
    }
}